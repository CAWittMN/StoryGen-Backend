...
class StoryGenAiApi {
   ...
   */
  generateInstructions(storyInfo) {
    const {
      genre,
      genImages,
      moods,
    ...
    const basicInstructionsSetting = setting
   ...
   */
  async startStory(storyInfo) {
    const storyAssistant = await this.openAi.beta.assistants.create({
...
const storyGenAi = new StoryGenAiApi();
